  ...
  <div class="px-0 py-0 d-flex flex-column brandora">
    ...
    <div class="hero-header">
      ...
      <p class="subtitle-1 mt-2 white--text">
        We use brand + retailer data to match you with perfectly aligned retailers.
      </p>
      ...
      <v-col cols="12" md="10" lg="9" class="content-bottom">
        <v-card elevation="6" class="mb-6 glass">
          ...
          <v-card-text class="white--text px-8">
            <p>
              Brandora helps brands expand wholesale by identifying retailers that fit your DNA, goals,
              and positioning. We replace cold outreach with targeted, data-driven match recommendations.
            </p>
            <ul class="white--text">
              <li><strong>Perfect-Match Retailers:</strong> Discover retailers aligned to your category, price point, audience, and values.</li>
              <li><strong>Objective Fit Scoring:</strong> Our data cuts through bias to surface the highest-leverage retail partners.</li>
              <li><strong>Faster Wholesale Growth:</strong> Focus your pipeline on retailers where you’re most likely to win.</li>
            </ul>
          </v-card-text>
        </v-card>
      </v-col>
